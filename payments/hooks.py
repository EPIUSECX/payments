...
doctype_js = {"Sales Invoice": "payments/public/js/sales_invoice_yoco_link.js"}
...
web_include_routes = {
    ...
    "/payments/yoco_webhook": "payments.payments.payment_gateways.yoco_webhook.handle_webhook"
}
